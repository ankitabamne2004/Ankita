...
def Total():
    ...
    #define cost of each item per quatity
    c1=60*a1
    c2=55*a2
    c3=10*a3
    c4=20*a4
...
#MENU CARD
f=Frame(root,bg="#144272",highlightbackground="black",highlightthickness=1,width=300,height=370)
f.place(x=10,y=118)

Label(f,text="Menu",font=("Gabriola",40,"bold"),fg="black",bg="#144272").place(x=80,y=0)

Label(f,font=("Lucida Calligraphy",15,'bold'),text="Dosa.......Rs.60/plate",fg="black",bg="#144272").place(x=10,y=80)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Cookies.......Rs.55/plate",fg="black",bg="#144272").place(x=10,y=110)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Tea.......Rs.10/cup",fg="black",bg="#144272").place(x=10,y=140)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Coffee.......Rs.20/cup",fg="black",bg="#144272").place(x=10,y=170)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Juice.......Rs.25/glass",fg="black",bg="#144272").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Pancakes.....Rs.50/pack",fg="black",bg="#144272").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Eggs.......Rs.40/plate",fg="black",bg="#144272").place(x=10,y=260)
...
#Label
lbl_dosa=Label(f1,font=("aria",20,'bold'),text="Dosa",width=12,fg="#1E5128")
lbl_cookies=Label(f1,font=("aria",20,'bold'),text="Cookies",width=12,fg="#1E5128")
lbl_Tea=Label(f1,font=("aria",20,'bold'),text="Tea",width=12,fg="#1E5128")
lbl_coffee=Label(f1,font=("aria",20,'bold'),text="Coffee",width=12,fg="#1E5128")
lbl_juice=Label(f1,font=("aria",20,'bold'),text="Juice",width=12,fg="#1E5128")
lbl_pancakes=Label(f1,font=("aria",20,'bold'),text="Pancakes",width=12,fg="#1E5128")
lbl_eggs=Label(f1,font=("aria",20,'bold'),text="Eggs",width=12,fg="#1E5128")
